    ...
    <>
      ...
      <Container>
        ...
        <p>
          ...
          покодить на python, пописать игрушки и прийти к frontend - разработке
          (еще успел пописать бэк)
        </p>
        <p>
        ...
        <p>
          ...
          ну и конечно работал с препроцессорами. С недавних пор все пишу на ts
          (как говорят, попробовав раз пописать на ts - на ванильный js не
          перясядешь)
        </p>
        <p>
